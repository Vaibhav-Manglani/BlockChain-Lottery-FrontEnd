...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <h2>Lottery</h2>
        <p>This Contract is hosted by {this.state.manager}. <br/>
          The number of players entered : {this.state.players.length}. <br/> 
          Total Prize : {web3.utils.fromWei(this.state.balance, 'ether')}.
          </p>
